...
export interface PromptPacket {
  ...
  costUsd?: number;
  /** hands-free listening window (ms) the all-voice client records before auto-submit */
  recordMs?: number;
  /**
...
export interface AttemptResult {
  ...
  correction: string;
  /** the warm cue spoken (l1 voice) — played before the model in the all-voice flow */
